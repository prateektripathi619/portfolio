...
const partnershipTypes = [
  {
    ...
    description: "Join as a sponsor for our developer events, coding sprints, and engineering conferences in India.",
    features: [
  ...
  },
  {
    ...
    description: "Partner with our academic programs to bridge the gap between industry and student developers.",
    features: [
  ...
  },
  {
    ...
    description: "Create value-driven content such as tutorials, webinars, and newsletters with our developer community.",
    features: [
...
const currentPartners = [
  ...
  "NItRR Metallurgical Department",
]
    ...
    <div className="flex flex-col gap-16 pb-16">
      <section className="pt-20 pb-12 bg-gradient-to-br from-blue-800/50 to-black">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-8 text-center">Partner with India's Software Talent</h1>
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-xl text-zinc-300">
              Explore opportunities to collaborate with developers, engineering colleges, and tech leaders across India.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-zinc-300 mb-6">
              India is a rising global tech innovation hub. Through our platform, you can build meaningful relationships with software engineers, universities, and development communities.
            </p>
            <p className="text-zinc-300 mb-8">
              We enable custom partnership strategies—whether you’re looking to hire, market, or build products.
            </p>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-8">
            <h3 className="text-2xl font-bold mb-6 gradient-text">Benefits of Partnership</h3>
          ...
          {partnershipTypes.map((type, index) => (
            <div key={index} className="valioux-card flex flex-col">
              ...
              <div className="p-6 border-t border-zinc-800">
                <Link href="/contact?type=partnership" className="btn-secondary w-full text-center">
                  Learn More
                </Link>
              </div>
            </div>
      ...
      <section className="section-container">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mb-12">
          {currentPartners.map((partner, idx) => (
            ...
            >
              <div className="text-zinc-500 font-medium">{partner}</div>
            </div>
          ))}
        </div>
        <p className="text-center text-zinc-300 max-w-2xl mx-auto">
          Join these tech leaders in building the future of engineering and innovation in India.
        </p>
      </section>
